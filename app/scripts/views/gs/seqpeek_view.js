define(["jquery", "underscore", "backbone", "hbs!templates/gs/seqpeek", "hbs!templates/line_item"],
    function ($, _, Backbone, SeqPeekTpl, LineItemTpl) {
            ...
            initCancerSelector: function (txt) {
                ...
                _.each(cancers, function (cancer) {
                    ...
                    if (selected_cancers.indexOf(cancer)) {
                        $(".cancer-selector").append(LineItemTpl({"li_class": "active", "a_class": "toggle-active", "id": cancer, "label": cancer}));
                    } else {
                        $(".cancer-selector").append(LineItemTpl({"a_class": "toggle-active", "id": cancer, "label": cancer}));
                    }
                });
