    ...
    function ($, _, Backbone, StacksVisTpl, QValueTpl) {
        return Backbone.View.extend({
            ...
            "initialize": function (options) {
                ...
                this.model["copy_number"].on("load", this.render_data_copy_number);
                this.model["q_value"].on("load", this.render_data_q_value);
            ...
            "render_data_q_value": function () {
                if (!this.model["q_value"].get("items")) return;

                var items_per_tumor_type = _.groupBy(this.model["q_value"].get("items"), "cancer");
            ...
            "render_data_copy_number": function () {
                ...
                _.each(this.model["copy_number"].get("BY_TUMOR_TYPE"), function (ttModel, tumor_type) {
