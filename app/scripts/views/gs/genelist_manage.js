define(["jquery", "underscore", "backbone", "hbs!templates/line_item", "hbs!templates/gs/genelist_manage"],
    function ($, _, Backbone, LineItemTpl, GeneListManageTpl) {
        return Backbone.View.extend({
            ...
            appendGenelists: function () {
                ...
                _.each(this.model.get("items"), function (item) {
                    genelistUL.append(LineItemTpl(_.extend(item, {"a_class": "load-list"})));
                });
            },
            ...
            initTypeahead: function (txt) {
                ...
                this.$el.find(".genes-typeahead").typeahead({
                    ...
                    updater: function (gene) {
                        _this.$el.find(".genelist-members").append(LineItemTpl({ "label": gene, "id": gene, "a_class": "item-remover", "i_class": "icon-trash" }));
                        return gene;
                    }
                });
            },
