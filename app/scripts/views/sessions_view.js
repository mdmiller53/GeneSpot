define(["jquery", "underscore", "backbone",
    ...
    function ($, _, Backbone, SessionLabelTemplate, LineItemTemplate) {
        ...
        return Backbone.View.extend({
            initialize: function (params) {
                ...
                WebApp.Sessions.All.on("add", this.loadSessions);
                this.loadSessions();
            },

            loadSessions: function () {
                this.$el.empty();
                _.each(WebApp.Sessions.All.models, function (item) {
            ...
            loadSession: function (e) {
                ...
                if (sessionId) {
                    ...
                    WebApp.Router.navigate("#s/" + sessionId, {trigger: true});
                }
            },
            ...
            saveNewSession: function () {
                ...
                WebApp.Sessions.All.create(newSession, {wait: true});
            },

            saveSession: function (e) {
                var sessionId = $(e.target).data("id");
                if (sessionId) {
                    var session = WebApp.Sessions.All.get(sessionId);
                    if (session) {
            ...
            getProducerAttributes: function () {
                ...
                _.each(WebApp.Sessions.Producers, function (producer, key) {
